...
#pragma warning restore CS0618
        ...
        public static Stream GenerateImage(int width, int height)
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                var pen = new Pen(System.Drawing.Color.FromArgb(random.Next(0, 255), random.Next(0, 255), random.Next(0, 255)), random.Next(1, 4));
